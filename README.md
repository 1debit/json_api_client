...
# PLEASE DO NOT ADD NEW FUNCTIONALITY

Instead please make PRs against the public repository https://github.com/JsonApiClient/json_api_client

This repository is slated to be archived
